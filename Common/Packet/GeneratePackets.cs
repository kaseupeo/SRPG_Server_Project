...
public class C_StartGame : IPacket
{
	...
	public float Y;
	public float Z;
	public ushort Protocol => (ushort)PacketID.C_StartGame;
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)PacketID.C_StartGame);
        count += sizeof(ushort);
...
public class S_ValidPosition : IPacket
{
    public int playerID;
	...
	public ushort Protocol => (ushort)PacketID.S_ValidPosition;
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)PacketID.S_ValidPosition);
        count += sizeof(ushort);
...
public class C_ClickPosition : IPacket
{
    public float X;
	public float Y;
	public float Z;
	public ushort Protocol => (ushort)PacketID.C_ClickPosition;
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)PacketID.C_ClickPosition);
        count += sizeof(ushort);
